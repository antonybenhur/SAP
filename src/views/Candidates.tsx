      ...
      <div className="bg-white dark:bg-neutral-900 rounded-lg border border-neutral-200 dark:border-neutral-800 overflow-hidden">
                ...
                <tr key={candidate.id} className="hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex-shrink-0 h-12 w-12">
                      {candidate.profile_photo_url ? (
                        <img
                          className="h-12 w-12 rounded-full object-cover border-2 border-neutral-200 dark:border-neutral-700"
                      ...
                      <div 
                        className={`h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center ${candidate.profile_photo_url ? 'hidden' : 'flex'}`}
                      >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-neutral-900 dark:text-white">
                      {candidate.primary_skill || 'Not specified'}
                    </div>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex items-center px-2 py-1 rounded-md text-xs font-medium ${statusColors[candidate.status]}`}>
        ...
        {filteredCandidates.length === 0 && (
          <div className="p-8 text-center">
            <p className="text-neutral-500 dark:text-neutral-400">No candidates found matching your criteria.</p>
          </div>
        )}
      </div>
