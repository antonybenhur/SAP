...
export const CreateUserModal: React.FC<CreateUserModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create the profile directly (without auth user for now)
            ...
            <div className="text-center">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
                <p className="text-sm text-blue-800 dark:text-blue-400">
                  <strong>Next Steps:</strong> The user will need to sign up through the normal registration process using their email address to get authentication access to the system.
                </p>
              </div>
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                <p className="text-sm text-blue-800 dark:text-blue-400">
                  <strong>Note:</strong> This creates a user profile only. The user will need to sign up through the normal registration process to get authentication access.
                </p>
              </div>
            </div>
